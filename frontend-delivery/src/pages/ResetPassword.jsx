...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      await api.post('/driver/auth/reset-password', { token, new_password: password })
      setSuccess(true)
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 px-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
        <div className="text-center">
          ...
          <h2 className="text-xl text-gray-600">Driver Portal — Set new password</h2>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-600 text-white py-2 rounded-lg hover:bg-primary-700 disabled:opacity-50 font-medium flex items-center justify-center gap-2"
          >
            {loading ? (
