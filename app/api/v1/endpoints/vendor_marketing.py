...
from app.core.config import resolve_upload_url, settings
...
def _vendor_ad_payments_suspended(db: Session) -> bool:
    ...
    if bool(data.get("suspend_vendor_ad_payments")):
        return True
    ...
    return bool(marketing_data.get("disable_vendor_ad_pricing"))
...
async def create_vendor_ad_payment_intent(
