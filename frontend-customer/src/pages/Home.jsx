          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="w-full">
              <div className="mb-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-2">
                  ...
                  <h2 className="text-base sm:text-base font-bold text-gray-900">
                    Browse Categories
                  </h2>
                </div>
              </div>
            ...
            <div className="w-full">
              ...
              <div className="space-y-3">
                ...
                .filter(item => nearbyStores.some(s =>
                  (s.region || '').split(',').map(r => r.trim()).includes(item.region)
                ))
                .map((item, index) => (
                  <Link
                    key={item.region}
...
const AutoScrollCarousel = ({ products, onQuickView, onAddToCart, onShowToast, favorites = new Set(), onToggleFavorite = () => {} }) => {
  ...
  return (
    <section className="-mt-4 sm:mt-0 pt-2 sm:pt-1 pb-4 sm:pb-4 bg-gradient-to-b from-gray-50 to-white w-full" style={{ display: 'block' }}>
