        ...
        <div className="mb-4 sm:mb-6 space-y-2 sm:space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent touch-manipulation"
            />
          </div>
          ...
          <div className="flex items-center gap-3 overflow-x-auto sm:flex-wrap sm:overflow-visible pb-1 sm:pb-0">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2.5 sm:py-2 min-h-[44px] border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm flex-shrink-0 touch-manipulation"
              type="button"
            >
